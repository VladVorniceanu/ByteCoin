...
#ifndef BYTECOIN_SWIFT_H
#define BYTECOIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ByteCoin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ByteCoin11AppDelegate")
...
SWIFT_CLASS("_TtC8ByteCoin13SceneDelegate")
...
SWIFT_CLASS("_TtC8ByteCoin14ViewController")
...
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified currencyPicker;
- (void)viewDidLoad;
